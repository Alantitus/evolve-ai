...
import { Download, Sparkles, Bot, Eye, Edit } from 'lucide-react'
  ...
  return (
    <div className="flex gap-6 h-full overflow-hidden">
      ...
      <div className={`flex flex-col bg-gray-50 relative transition-all duration-300 overflow-hidden ${
        showPreviewPanel ? 'w-2/3 max-w-4xl' : 'w-full max-w-4xl mx-auto'
      }`}>
        {/* Messages Area */}
        {messages.length === 0 ? (
          ...
          <div className="flex-1 overflow-y-auto p-6 m-4 bg-white rounded-lg shadow-sm">
      ...
      {/* Preview Panel */}
      {showPreviewPanel && (
        <div className="flex-1 flex flex-col bg-white rounded-lg shadow-sm border border-gray-200 animate-slideIn overflow-hidden">
